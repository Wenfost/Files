...
function telegram.sendMessage(msg, options)
    ...
    options = options or {} -- РџРѕ СѓРјРѕР»С‡Р°РЅРёСЋ РїСѓСЃС‚Р°СЏ С‚Р°Р±Р»РёС†Р°, РµСЃР»Рё РѕРїС†РёРё РЅРµ РїРµСЂРµРґР°РЅС‹
    msg = msg:gsub('{......}', '') -- РЈР±РёСЂР°РµРј С†РІРµС‚РѕРІС‹Рµ РєРѕРґС‹
    msg = encodeUrl(msg) -- РљРѕРґРёСЂСѓРµРј С‚РµРєСЃС‚ РґР»СЏ URL
    local parseMode = options.parse_mode or "Markdown" -- Р�СЃРїРѕР»СЊР·СѓРµРј Markdown РїРѕ СѓРјРѕР»С‡Р°РЅРёСЋ
